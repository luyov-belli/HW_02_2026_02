...
% =============================================================================
% 10pt y no 11: el enunciado limita el informe a 8-12 páginas y a 11pt salían 13
% incluso tras emparejar figuras y reducir el espaciado de floats. Reducir el
% cuerpo conserva todo el análisis, que es lo que se califica; el margen sube a
% 2.7 cm para que la medida de línea no se alargue de más.
...
\label{tab:fuentes}
% Sin columna «Rol»: el papel de cada insumo se explica en el texto que sigue y
% esa columna era la más ancha de las cuatro.
\begin{tabular}{p{3.2cm}p{7.4cm}p{3.6cm}}
\toprule
\textbf{Insumo} & \textbf{Fuente} & \textbf{Licencia} \\
\midrule
Establecimientos de salud (oferta) &
