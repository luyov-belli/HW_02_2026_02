...
\begin{abstract}
\noindent
Se mide el tiempo de viaje por carretera desde \num{5000} puntos de demanda
poblacional hasta el establecimiento de salud resolutivo más cercano
(categoría II-1 o superior, operativo) en los 25 departamentos del Perú,
ruteando sobre la red vial de OpenStreetMap con OSRM. Los puntos representan
\kpiPoblacionTotal{} habitantes mediante un diseño muestral con pesos. El
tiempo mediano ponderado por población es de \kpiTiempoMediano{} minutos y el
percentil 90 llega a \kpiTiempoPnoventa{} minutos. El \kpiShareHasta30\,\% de
la población está a 30 minutos o menos, el \kpiShareHasta60\,\% a una hora, y
\kpiPobMas120{} personas (\kpiShareMas120\,\%) viven a más de dos horas. El
Gini del tiempo de acceso es \kpiGini{}. La población rural tarda
\kpiTiempoMedioRural{} minutos en promedio frente a
\kpiTiempoMedioUrbano{} minutos de la urbana. Un análisis con distancia en
línea recta declararía cubierta dentro de una hora a \kpiPobReclasificada{}
personas que no lo están, y elegiría un establecimiento más cercano distinto en
el \kpiShareCambiaCercano\,\% de los casos. Ascender
\kpiMclpPresupuesto{} establecimientos I-3/I-4 seleccionados por cobertura
máxima incorporaría \kpiMclpGanancia{} habitantes al umbral de una hora.
\end{abstract}
...
recta penalizada ($\times 1{,}35$ a \SI{25}{\km\per\hour}); y, si el origen está
a más de \SI{20}{\km} de cualquier vía, \textbf{no se imputa}: se marca como
...
a \SI{20}{\km} inventaría infraestructura inexistente.
...
\kpiShareHasta30\,\% alcanza un establecimiento resolutivo en \num{30} minutos o
menos y el \kpiShareHasta60\,\% en una hora. En el otro extremo,
\kpiPobMas120{} personas —el \kpiShareMas120\,\% de la población— viven a más de
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.72\textwidth]{fig1_choropleth_acceso}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{fig2_cobertura_acumulada}
\caption{Cobertura acumulada por tiempo de acceso, urbano frente a rural. La
distancia horizontal entre las dos curvas es la brecha de acceso a cada nivel de
cobertura, no un promedio.}
\label{fig:ecdf}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.52\textwidth]{fig3_lorenz}
\caption{Curva de Lorenz del tiempo de viaje. El eje horizontal ordena a la
población de menor a mayor tiempo de acceso; la separación respecto de la
diagonal es la concentración de la carga de desplazamiento en una minoría.}
\label{fig:lorenz}
\end{figure}

\input{tables/tab_cobertura_departamento}
...
\input{tables/tab_peores_distritos}

\subsection{Análisis cruzado}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{fig4_acceso_vs_altitud}
...
\input{tables/tab_analisis_cruzado}
...
\input{tables/tab_multimodal}

\subsection{Evolución en el tiempo}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{fig6_temporal_cobertura}
...
\input{tables/tab_temporal}

\subsection{Dónde conviene invertir: cobertura máxima}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fig5_mclp_secuencia}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.72\textwidth]{fig7_linea_recta_vs_red}
...
acceso vial» cuando están a más de \SI{20}{\km} de cualquier vía, pero no modela
...
\begin{enumerate}
\item \textbf{La cobertura nacional a una hora es de \kpiShareHasta60\,\% y la
cola importa más que el promedio.} \kpiPobMas120{} personas están a más de dos
